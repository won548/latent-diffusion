...
def parse_args():
    ...
    parser.add_argument('--ckpt', type=str, default='2024-06-18T15-09-49_cspine-ldm-vq-f8-cond')
            ...
            with model.ema_scope():
                ...
                for class_label in classes:
                    ...
                    for img in all_samples[class_label]:
                        ...
                        cv2.imwrite(f"samples/{name}-train/{class_label}/{name}-step{ddim_steps}-ddim_eta{ddim_eta}-scale{scale}-class_label{class_label}-{n_class_samples[class_label]}.png", img)
